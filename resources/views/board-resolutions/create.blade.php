                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex">
                                        @include('inc.back')
                                        <h2>Create Board Resolution</h2>
                                    </div>
                                </div>
                                <div class="card-body">
                                    {!! Form::open(['action' => 'BoardResolutionsController@store', 'method' => 'POST' , 'enctype' => 'multipart/form-data', 'class' => 'box']) !!}
                                        ...
                                        <div class="form-group">
                                            <h6>{{Form::label('description', 'Content')}}</h6>
