                                ...
                                <div class="card-body">
                                    {!! Form::open(['action' => 'DuesController@store', 'method' => 'POST' , 'enctype' => 'multipart/form-data']) !!}
                                        <div class="form-row">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div class="form-group">
                                                    <label>HO ID</label>
                                                    {!!Form::text('tenant_id', $due->tenant->id, ['placeholder' => 'Please pick one', 'class' => 'form-control input-label rounded-0', 'readonly' => true])!!}
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                <div class="form-group">
                                                    {{Form::text('last_name', $due->tenant->last_name, ['class' => ($errors->has('last_name')) ? 'form-control input-label rounded-0 is-invalid' : 'form-control input-label rounded-0', 'placeholder' => 'Last Name', 'readonly' => true])}}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                <div class="form-group">
                                                    {{Form::text('first_name', $due->tenant->first_name, ['class' => ($errors->has('first_name')) ? 'form-control input-label rounded-0 is-invalid' : 'form-control input-label rounded-0', 'placeholder' => 'First Name', 'readonly' => true])}}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                <div class="form-group">
                                                    {{Form::text('middle_name', $due->tenant->middle_name, ['class' => ($errors->has('last_name')) ? 'form-control input-label rounded-0 is-invalid' : 'form-control input-label rounded-0', 'placeholder' => 'Middle Name', 'readonly' => true])}}
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                                <div class="form-group">
                                        ...
                                        <table class="table table-striped table-sm">
                                                ...
                                                @foreach ($dues as $due)
                                                <tr>
                                                    <th>{{$due->transaction_date->format('F')}}</th>
                                                    <th>{{$due->amount}}</th>
                                                    <th>
                                                    @if ($due->amount != 0)
                                                        Paid
                                                        ...
                                                        <div class="modal-body pb-0">
                                                                ...
                                                                <div class="form-row">
                                                                    ...
                                                                    <div class="d-flex w-100 justify-content-end mt-3">
                                                                        ...
                                                                        <div class="form-group pr-2 pl-2">
                                                                            <button type="submit" class="btn btn-primary primary-bg rounded-0" data-dismiss="modal">CANCEL</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </div>
