<header class="page-header row justify-center">
    ...
    <div class="float-left text-center text-md-left input-group">
        <input id="btn-input" type="text" class="form-control input-md" placeholder="Search" />
        <span class="input-group-btn">
        <button class="btn btn-primary btn-md border-left-0"><i class="fa fa-search"></i></button>
        </span>
    </div>
    </div>
</header>