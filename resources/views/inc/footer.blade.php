        ...
        <div class="row">
            ...
            <div class="widget col-lg-3 col-md-3 col-sm-12">
                ...
                <ul class="recent_posts">
                    <li>
                        <a href="home1.html#">Our New Dashboard Is Here</a>
                        <a class="readmore primary-color" href="#">read more</a>
                    </li>
                    <li>
                        <a href="home1.html#">Design Is In The Air</a>
                        <a class="readmore primary-color" href="#">read more</a>
                    </li>
                </ul>
            </div>
            <div class="widget col-lg-3 col-md-3 col-sm-12">
                ...
                <ul class="contact_details">
                    ...
                    <li><a href="#" class="primary-color"><i class="fa fa-map-marker"></i> View large map</a></li>
                </ul>
            </div>
            <div class="widget col-lg-3 col-md-3 col-sm-12">
