                                                ...
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                <label class="primary-color"><i class="fa fa-calendar"></i> DATE FROM</label>
                                                                {!! Form::date('date_from',Carbon\Carbon::now(), ['class' => 'form-control input-label rounded-0']) !!}
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                            <div class="form-group">
                                                                <label class="primary-color"><i class="fa fa-calendar"></i> DATE TO</label>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content rounded-0 border-0">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Car Stickers</h5>
