                            ...
                            <div class="col-12 col-md-12 col-lg-10 col-xl-10">
                                <div class="form-group">
                                    <div class="form-row mx-auto">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
                                            {{Form::email('email', '', ['class' => ($errors->has('email')) ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Email'])}}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row mx-auto">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                            {{Form::date('birth_date', \Carbon\Carbon::now(), ['class' => ($errors->has('birth_date')) ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Birth Date'])}}
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
                                            {{Form::text('province', '', ['class' => ($errors->has('province')) ? 'form-control form-control-sm is-invalid' : 'form-control form-control-sm', 'placeholder' => 'Province'])}}
                                        </div>
                                    </div>
                                </div>
