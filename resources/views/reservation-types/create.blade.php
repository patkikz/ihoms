                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                {!! Form::open(['action' => 'ReservationTypesController@store', 'method' => 'POST' , 'enctype' => 'multipart/form-data', 'class' => 'well']) !!}

                                    <div class="form-group">
                                        <h6>{!!Form::label('reservation_type', 'Reservation Type')!!}</h6>
                                        {!!Form::text('reservation_type', '', ['placeholder' => 'Reservation Type', 'class' => 'form-control input-label rounded-0'])!!}
                                    </div>
